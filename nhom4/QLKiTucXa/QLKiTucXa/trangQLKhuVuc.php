...
<div class="main-content">
    <center><h3 class="mt-2">Quản Lý Khu Vực </h3></center>
        ...
        <tbody>
            ...
            if (count($result) > 0) {
                foreach ($result as $row) {
                    ...
                    echo "<button type='button' class='btn btn-light mr-1' onclick='deleteKhuVuc({$row['KhuVucID']})'>";
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addFormKhuVuc" action="themKhuVuc.php" method="post">
                        
                        <div class="input-group mb-3">
                            <span class="input-group-text col-2">Tên khu vực</span>
                            <input type="text" class="form-control" id="addTenKhuVuc" name="TenKhuVuc" />
                        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editFormKhuVuc" action="suaKhuVuc.php" method="post">
                        <div class="input-group mb-3">
                            <span class="input-group-text col-2">ID</span>
                            <input type="text" class="form-control" id="editKhuVucID" name="KhuVucID" readonly />
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text col-2">Tên khu vực</span>
                            <input type="text" class="form-control" id="editTenKhuVuc" name="TenKhuVuc" />
                        </div>
...
<script>
function editClick(khuVuc) {
    document.getElementById('editKhuVucID').value = khuVuc.KhuVucID;
    document.getElementById('editTenKhuVuc').value = khuVuc.TenKhuVuc;
}

function deleteKhuVuc(id) {
    if (confirm("Bạn có chắc chắn muốn xóa khu vực này?")) {
        window.location.href = "xoaKhuVuc.php?id=" + id;
    }
}
</script>
</body>
